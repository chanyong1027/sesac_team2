...
class PromptVersionControllerTest {
        ...
        void getVersions_Success() throws Exception {
                ...
                List<PromptVersionSummaryResponse> response = List.of(
                                new PromptVersionSummaryResponse(2L, 2, "버전 2", ProviderType.OPENAI, "gpt-4", null,
                                                null, false, userId, "테스트 유저", LocalDateTime.now()),
                                new PromptVersionSummaryResponse(1L, 1, "버전 1", ProviderType.OPENAI, "gpt-3.5-turbo",
                                                null, null, false, userId, "테스트 유저", LocalDateTime.now()));
