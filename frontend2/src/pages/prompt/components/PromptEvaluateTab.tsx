                                    ...
                                    <div className="space-y-3 max-h-[620px] overflow-auto pr-1">
                                        {caseFormRows.map((row, idx) => (
                                            <CaseEditorRow
                                                ...
                                                setAdvancedJsonOpenByRow={setAdvancedJsonOpenByRow}
                                                updateCaseRow={updateCaseRow}
                                                setContextLanguage={setContextLanguage}
                                                setCaseArrayField={setCaseArrayField}
                                                setCaseBooleanFlag={setCaseBooleanFlag}
                                                setConstraintMaxChars={setConstraintMaxChars}
                                                setConstraintLanguage={setConstraintLanguage}
                                                setConstraintKeywordNormalization={setConstraintKeywordNormalization}
